...
% [x,y]=ndgrid(1:2:size(Fext,1),1:2:size(Fext,2));
% figure; imshow(I,[],'InitialMagnification','fit'), hold on; quiver(y,x,Fext(1:2:end,1:2:end,2),Fext(1:2:end,1:2:end,1));

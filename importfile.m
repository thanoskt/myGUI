function [variable,desired_name] = importfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   [VARIABLE,DESIRED_NAME] = IMPORTFILE(FILENAME) Reads data
%   from text file FILENAME for the default selection.
%
%   [VARIABLE,DESIRED_NAME] = IMPORTFILE(FILENAME, STARTROW,
%   ENDROW) Reads data from rows STARTROW through ENDROW of text file
%   FILENAME.
%
% Example:
%   [variable,desired_name] = importfile('ParamFile.txt',2, 4);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2017/10/05 15:55:50
